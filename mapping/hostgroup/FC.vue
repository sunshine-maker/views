              ...
              <a-spin :spinning="confirmLoading">
                <a-form :form="form">
                  ...
                  <a-select
                         v-decorator="[
                           'select',
                           {rules: [{ required: true, message: '请选择/添加成员' }]}
                         ]"
                         placeholder="请选择/添加成员"
                       >
                         <a-select-option value="WWN">
                           WWN.100000000C97DCB40
                         </a-select-option>
                       </a-select>
                    </a-form-item>
                </a-form>
